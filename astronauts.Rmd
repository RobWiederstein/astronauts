...
The "Space Race" was a competition between  cold War rivals: the United States and U.S.S.R.  The Race begain in 1955 when the U.S. announced  its intent to launch four orbiting satellites.  The U.S.S.R. successfully launched the first orbiting satellite, Sputnik I, and sent the first human to space, Yuri Gagarin, on April 12, 1961.  The height of the Race was the U.S. landing the first person on the moon on July 20, 1969.  The mission was "Apollo 11." See the Wikipedia [article](https://en.wikipedia.org/wiki/Space_Race).
...
g1 <- igraph::simplify(g)
#legend
legend_cats <- data.frame(attr = unique(vertex_attr(g1, "nationality_f")),
                          color = unique(V(g1)$nationality_col))
...
legend(x = "bottomleft",      ## position, also takes x,y coordinates
       legend = c("U.S.", "Russia", "Other"), #legend_cats$attr,
